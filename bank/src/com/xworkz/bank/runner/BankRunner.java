...
import com.xworkz.bank.constants.ConnectionConst;
import com.xworkz.bank.query.BankInsert;
import com.xworkz.bank.readoperation.SelectQuery1;
import com.xworkz.bank.readoperation.SelectQuery2;
import com.xworkz.bank.readoperation.SelectQuery3;
import com.xworkz.bank.readoperation.SelectQuery4;
import com.xworkz.bank.readoperation.SelectQuery5;
import com.xworkz.bank.readoperation.SelectQuery6;
	...
	public static void main(String[] args) {
		...
		try {
			...
			Statement statement = connection.createStatement();
			 ...
			 //int result = statement.executeUpdate(new BankInsert().getInsertQuery());
			// if (result > 0)
