...
import com.xworkz.tab.constants.ConnectionConst;
import com.xworkz.tab.query.TabInsert;
import com.xworkz.tab.readoperation.SelectQuery1;
import com.xworkz.tab.readoperation.SelectQuery2;
import com.xworkz.tab.readoperation.SelectQuery3;
import com.xworkz.tab.readoperation.SelectQuery4;
import com.xworkz.tab.readoperation.SelectQuery5;
import com.xworkz.tab.readoperation.SelectQuery6;
...
public class TabRunner {
	...
	try {
		...
		int result = statement.executeUpdate(new TabInsert().getInsertQuery());
		 if (result > 0)
