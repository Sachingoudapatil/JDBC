...
import com.xworkz.laptop.constants.ConnectionConst;
import com.xworkz.laptop.query.LaptopInsert;
import com.xworkz.laptop.readoperation.SelectQuery1;
import com.xworkz.laptop.readoperation.SelectQuery2;
import com.xworkz.laptop.readoperation.SelectQuery3;
import com.xworkz.laptop.readoperation.SelectQuery4;
import com.xworkz.laptop.readoperation.SelectQuery5;
import com.xworkz.laptop.readoperation.SelectQuery6;
...
public class LaptopRunner {
	...
	try {
		...
		//int result = statement.executeUpdate(new LaptopInsert().getInsertQuery());
		// if (result > 0)
		...
		while (resultSet3.next()) {
			System.out.println(resultSet3.getString("model"));
		}
